...
export const bands: Band[] = [
  { 
    ...
    members: [
      { name: "โต (วีรณัฐ ทรัพย์สัณฐาน)", role: "ร้องนำ" },
      { name: "ต้น (จักรพินธ์ รัตนบุญมงคล)", role: "กีตาร์" },
      { name: "หรั่ง (เทวฤทธิ์ ศรีสุข)", role: "เบส" },
      { name: "ต่อ (ต่อตระกูล ใบเงิน)", role: "กลอง" },
    ],
    },
     { 
    id: 2,
    ...
    members: [
      { name: "เอ (ฐิติภัทร อรรถจินดา)", role: "นักร้องนำ / กีตาร์" },
      { name: "ดอย (อภิวิชญ์)", role: "กลองชุด" },
      { name: "ธนดล (จ๋วงพานิช)", role: "เบส" },
    ],
    }, { 
    id: 3,
    name: "Television Off",
    ...
    members: [
      { name: "เฟิร์ส - ภวัต พันธ์วิจิตร", role: "ร้องนำ" },
      { name: "โชค - ศุภโชค เชื้อประทุม", role: "กีตาร์" },
      { name: "ลาภ - ศุภลาภ ถิรพรประเสริฐ", role: "กีตาร์" },
      { name: "โบ้ - โบกี้", role: "เบส" }, 
    ],
    },
